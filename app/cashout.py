...
class CashoutManager:
    ...
    async def evaluate_all(self):
        """Evaluate all open positions for cashout triggers."""
        ...
        for pos in positions:
            ...
            if pnl_pct <= self.settings.stop_loss_pct:
                ...
                cashout_size = size * (self.settings.tp1_size_pct / 100)
            ...
            if action:
                actions.append({
                    ...
                    "cashout_size": round(cashout_size, 4),
                ...
                # Execute cashout
                try:
                    outcome = "YES" if (side == "YES" or side == "BUY") else "NO"
